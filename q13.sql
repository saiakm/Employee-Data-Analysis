...
select distinct q1.src src, q1.dst dst from (select distinct q1.title src, q2.title dst from 
(SELECT distinct title FROM employees.titles) q1, (SELECT distinct title FROM employees.titles) q2) q1
